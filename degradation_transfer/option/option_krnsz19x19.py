...
class Config:
    def __init__(self):
        ...
        self.parser.add_argument('--G_structure', type=list, default=[7, 5, 3, 3, 3, 3],
        ...
        self.parser.add_argument('--G_kernel_size', type=int, default=19,
        ...
        self.parser.add_argument('--lambda_boundaries', type=float, default=1000,
